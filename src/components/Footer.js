...
//               <h3 className="text-white font-semibold mb-4">About Us</h3>
//               <ul className="space-y-2">
//                 <li><Link to="/master-plan" className="hover:text-white">Master Plan</Link></li>
//                 <li><Link to="/jobs" className="hover:text-white">Jobs</Link></li>
//                 <li><Link to="/invest" className="hover:text-white">Invest</Link></li>
//                 <li><Link to="/pressroom" className="hover:text-white">Pressroom</Link></li>
...
//               <h3 className="text-white font-semibold mb-4">Explore EEVE</h3>
//               <ul className="space-y-2">
//                 <li><Link to="/unlock-robot-power" className="hover:text-white">Unlock my Robot Power</Link></li>
//                 <li><Link to="/starlight" className="hover:text-white">Starlight</Link></li>
//                 <li><Link to="/robot-platform" className="hover:text-white">Robot Platform</Link></li>
//                 <li><Link to="/eeve-roadmap" className="hover:text-white">EEVE Roadmap</Link></li>
//               </ul>
//             </div>
...
//               <ul className="space-y-2">
//                 <li><Link to="/willow-community" className="hover:text-white">Willow X Community</Link></li>
//                 <li><Link to="/developer-access" className="hover:text-white">Developer & Maker Access</Link></li>
//                 <li><Link to="/special-cases" className="hover:text-white">Special Cases</Link></li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
//         <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center text-sm">
//           <div className="flex space-x-6">
//             <Link to="/march22-recap" className="hover:text-white">March22 Recap</Link>
